...
if(isset($_POST['submit'])){
    ...
    $nomerhp = htmlspecialchars($_POST['no-hp']);
    $password1 = htmlspecialchars($_POST['password']);
    $password2 = htmlspecialchars($_POST['repassword']);

    // cek apakah username  sudah ada/terpakai
    $sqlcek ="SELECT * FROM akun_siswa WHERE username = '$username'";
    $hasilcek =mysqli_fetch_assoc(mysqli_query($conn,$sqlcek));

    // cek password pertama dan kedua apakah sama
    if($password1 != $password2){
        ...
        if($hasilcek){
            ...
            // prosses tambah akun
            $data ="INSERT INTO akun_siswa VALUES ('NULL','$name','$username','$nomerhp','$passwordakhir')";
            $insert = mysqli_query($conn,$data);
           
            if($insert){
            echo "<script>
            alert('Registrasi Berhasil'),window.location.href='index.php';</script>";
            }else{
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav" style="font-weight: bold;">
                    ...
                    <!-- <a class="nav-link btn btn-outline-danger" href="login.php">Kembali</a> -->
                    <!-- <a class="nav-link" href="registrasi.php">Registration</a> -->
                </div>
                <div class="navbar-nav ml-auto" style="font-weight: bold;">
                    <!-- <span class="nav-link active" href="#">Sistem Pendaftaran Online BLK <span class="sr-only">(current)</span></a> -->
                    <a class="nav-link btn btn-outline-danger" href="login.php">Kembali</a>
                    <!-- <a class="nav-link" href="registrasi.php">Registration</a> -->
                </div>
            </div>
    ...
    <div class="container">
        <div class="card" style="width: 25rem; margin:0 auto; margin-top:100px;">
            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="no-hp" type="text" class="form-control" id="no-hp" >
                    ...
                    <button name="submit" type="submit" class="btn btn-primary btn-lg btn-block">Regist</button>
                </form>
            </div>
        </div>
    </div>
